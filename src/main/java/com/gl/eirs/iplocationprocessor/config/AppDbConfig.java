...
@EnableJpaRepositories(
        basePackages = {"com.gl.eirs.iplocationprocessor.repository.app"},
        entityManagerFactoryRef = "springEntityManagerFactory",
        transactionManagerRef = "springTransactionManager")
@EntityScan({"com.gl.eirs.iplocationprocessor.entity.app"})
public class AppDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.gl.eirs.iplocationprocessor.entity.app")
